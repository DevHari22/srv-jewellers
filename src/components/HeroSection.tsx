    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 py-16 sm:py-24 md:py-32 lg:py-40">
        <div className="max-w-xl mx-auto md:mx-0 text-center md:text-left px-4 md:px-0">
          <div className="inline-block bg-[#F9A602]/80 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            <span className="text-[#4A3212] font-semibold text-sm sm:text-base">New Collection 2023</span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold text-white mb-6 sm:mb-8 leading-tight">
            Exquisite <span className="text-[#F9A602]">Jewelry</span> For Every Occasion
          </h1>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 items-center sm:items-start justify-center md:justify-start">
            ...
            <Button variant="outline" className="border-2 border-white bg-transparent text-white hover:bg-white/20 hover:text-white text-base sm:text-lg px-8 py-6 rounded-md w-full sm:w-auto" asChild>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-[#F9A602]/80 backdrop-blur-sm py-2.5 z-20">
