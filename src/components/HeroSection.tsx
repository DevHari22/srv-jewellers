    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 py-20 md:py-28 lg:py-36">
        <div className="max-w-xl text-center md:text-left">
          <div className="inline-block bg-gold px-3 py-1 rounded-full mb-4">
          ...
          <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4 items-center md:items-start">
            <Button className="bg-gold hover:bg-gold/90 text-maroon-dark text-base px-6 py-6 md:py-3 rounded-md w-full md:w-auto" asChild>
              <Link to="/collections">Shop Collections</Link>
            </Button>
            <Button variant="outline" className="border-gold text-white hover:bg-gold hover:text-maroon-dark text-base px-6 py-6 md:py-3 rounded-md w-full md:w-auto" asChild>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gold/90 py-2 z-20">
